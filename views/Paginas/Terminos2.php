<div class="row">
	...
	<div class=col-md-12>
		<img src="images/prevenir/terminos.png" style="max-width: 100%; padding-top: 50px; width: 100%;">
	</div>
...
<div class="contenido"> 
	...
	<div class="row"> 
		...
		<div class="col-md-10"> 
			<h2 class="text-center tituloPrincipal">Términos y Condiciones</h2>

			<p>Para recibir descuentos debe estar inscrito y sus datos diligenciados al 100%, Los descuentos deberá ser redimido a nuestros terceros para confirmar día fecha y hora de su requerimiento. No tenemos límite de descuentos por persona. El descuento se enviará vía mail, WhatsApp, mensaje de texto o en su defecto se le llamara personalmente para conocimiento del solicitante. Para preguntas o reclamos (PQRS) se debe ingresar a www.prevenirexpress.com en espacio PQRS o al correo clientes@prevenirexpress.com Se debe enviar un e-mail ha solicitado su requerimiento o comunicarse a los teléfonos (2) 7290038 o wpp 310 4351937, 3172645522, o al correo admin@prevenirexpress.com. </p>

			<small>* Los descuentos los aplica la entidad jurídica o natural de acuerdo a sus condiciones y restricciones.</small>
			<small>*Aplican condiciones y restricciones a todos los descuentos</small>
			...
			<div id="accordion">
				<div class="card">
					...
					<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
						<div class="card-body">
							...
							<p>1.1 FINALIDAD DE LA BASE DE DATOS. La base de datos tiene como finalidades principales informarle sobre los servicios que prestamos en primera persona y/o con terceros, para fines comerciales, administrativos y publicitarios y contacto frente a los titulares de los mismos.  </p>
							<p>1.2 DATOS PERSONALES. La información objeto de tratamiento por parte de GRUPO PREVENIR EXPRESS sas. En adelante en este documento “Datos personales”, es aquella que suministran los Titulares, cuando acceden a sus bienes y/o servicios, o con ocasión de los mismos, tales como: nombre, apellidos, identificación, edad, sexo, teléfono, dirección física y electrónica, país, ciudad y demás datos sensibles pero necesarios que le sean solicitados en el proceso de registro, los cuales en ningún caso serán manipulados ni entregado a terceros sin su autorización como lo dispone la ley. GRUPO PREVENIR ESPRESS sas. Se reserva el derecho de modificar esta política sin previo aviso. Los cambios realizados no afectarán las obligaciones ni seguridad exigida por la normatividad vigente. Los cambios realizados podrán ser anunciados a los usuarios a través de la página web y/o a través de correo electrónico, sin embargo usted debe comprobar nuestro sitio web para ver los cambios recientes. Dado el carácter vinculante de los términos y condiciones, es responsabilidad única del Usuario revisar los términos vigentes en cada momento. La presente política se publica el marzo del 2019. </p>

						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingTwo">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingThree">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
								3. COOKIES
							</button>
						</h5>
					</div>
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingFourt">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseFourt" aria-expanded="false" aria-controls="collapseFourt">
								4. E-MAILS
							</button>
						</h5>
					</div>
					<div id="collapseFourt" class="collapse" aria-labelledby="headingFourt" data-parent="#accordion">
						<div class="card-body">
							<p>Nuestra Política, respecto del envío de emails, tiene finalidades principales de nuestro negocio: E-mails con recordatorios de los servicios que ofrecemos (especialmente de las campañas que aún no haya esgrimido o no haya utilizado en un tiempo considerable). En cada uno de los e-mails siempre ofreceremos la posibilidad de dejar de recibir e-mails en el futuro, enviándonos un E-mail. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingFive">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
					...
					<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
						<div class="card-body">
							<p>Empleamos diversas técnicas de seguridad para proteger datos de accesos no autorizados. Sin embargo, es necesario tener en cuenta que la seguridad perfecta no existe en Internet. Por ello, GRUPO PREVENIR no se hace responsable por interceptaciones ilegales o violación de sus sistemas o base de datos por parte de personas no autorizadas. GRUPO PREVENIR, tampoco se hace responsable por la indebida utilización de la información obtenida por esos medios.  </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingSix">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingSeven">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingEight">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
					...
					<div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion">
						<div class="card-body">
							<p>Para hacer más efectivas y seguras las transacciones que se lleven a cabo en el descuento. Para la administración del Sitio Web en el que el usuario entra para explorar las ofertas y promociones proporcionadas por cada proveedor. Para cumplir a cabalidad con los servicios celebrados con los clientes y usuarios, de acuerdo con sus finalidades para brindar las ofertas, promociones, servicios o productos de GRUPO PREVENIR o de terceros. Para complementar la información y en general adelantar las actividades necesarias para gestionar las solicitudes, quejas y reclamos presentados por los usuarios o proveedor medico de GRUPO PREVENIR, por terceros y direccionarlas a las áreas responsables de emitir las respuestas correspondientes. Enviar información y ofertas comerciales de productos de GRUPO PREVENIR, así como realizar actividades de mercadeo. Esto, como finalidad principal en el tratamiento de datos personales por parte de GRUPO PREVENIR y objeto social, consistentes en la difusión efectiva de las ofertas que realiza, dado su carácter temporal. La personalización de clientes con el fin de hacerlos partícipes de los diferentes programas de beneficios e informaciones promocionales. Elaborar estudios de mercado, estadísticas, encuestas, análisis de tendencias del mercado, encuestas de satisfacción sobre los servicios prestados por GRUPO PREVENIR. Para la transmisión de datos personales a terceros con los cuales se hayan celebrado contratos con este objeto, para fines comerciales, administrativos y/o operativos. Gestionar toda la información necesaria para el cumplimiento de las obligaciones tributarias y de registros comerciales, corporativos y contables de GRUPO PREVENIR. Para identificar a los usuarios cuando ingresen al Sitio Web. Para ofrecer a los clientes servicios y funcionalidades que se adecuan a los gustos e intereses personalizados. Para proceder a la facturación y cobro de los servicios de compra directa. Para enviar información o mensajes sobre los nuevos productos y/o servicios, mostrar la publicidad o promoción del momento, banners, noticias sobre GRUPO PREVENIR y toda otra información que creamos conveniente. Compartir los datos con empresas de servicios o empresas de “Outsourcing” que contribuyan a mejorar o a facilitar las operaciones a través de GRUPO PREVENIR, dentro de las que se incluyen, medios de pago, seguros o intermediarios de la gestión de pagos. GRUPO PREVENIR velará porque las políticas de los terceros tengan estándares similares a los de la presente Política, mediante la firma de acuerdos, convenios y/o contratos. Para suministrar los datos a las entidades que intervengan en la resolución de conflictos y que tengan competencia para ello.  </p>
							<p>8.1 Información de identificación personal (IIP) como nombres y apellidos, teléfono, dirección y otro tipo de información que le permita a GRUPO PREVENIR identificar a los usuarios. También se solicitará información personal para comprar o separar alguno de los servicios que el proveedor medico ofrezca con sus respectivo descuentos, a saber: (i) nombres y apellidos; (ii) dirección; (iii) dirección de correo electrónico; (iv) fecha de nacimiento; (v) número telefónico; y (vi) datos relacionados con el medio de pago. </p>
							<p>8.2 Dirección IP (Internet Protocolo) con el fin de diagnosticar problemas o inconvenientes con nuestro servidor, así como para administrar su Sitio Web. Una dirección de IP es un número que se le asigna a su computadora cuando usa internet. Su dirección de IP también es utilizada para ayudar a identificarle dentro de una sesión particular y para recolectar información demográfica general. Correo electrónico para la utilización del Sitio Web, la vinculación a GRUPO PREVENIR. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingNine">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingTen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseTen" aria-expanded="false" aria-controls="collapseTen">
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingEleven">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingTwelve">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">
								12. CÓDIGO DE ÉTICA
							</button>
						</h5>
					</div>
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingThirdteen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseThirdteen" aria-expanded="false" aria-controls="collapseThirdteen">
								13. TERRITORIO
							</button>
						</h5>
					</div>
				...
				<div class="card">
					<div class="card-header cardTitulo" id="headingFourteen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseFourteen" aria-expanded="false" aria-controls="collapseFourteen">
					...
					<div id="collapseFourteen" class="collapse" aria-labelledby="headingFourteen" data-parent="#accordion">
						<div class="card-body">
							...
							<p>14.1. Descargar la aplicación móvil “PREVENIR EXPRESS” se puede probar gratis registrarse con Facebook o ingresar Nombre, Correo electrónico y clave para poder acceder a la App. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingFiveteen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseFiveteen" aria-expanded="false" aria-controls="collapseFiveteen">
					...
					<div id="collapseFiveteen" class="collapse" aria-labelledby="headingFiveteen" data-parent="#accordion">
						<div class="card-body">
							<p>Será responsable de la publicidad de la Actividad, la cual puede realizarse en toda la variedad de formatos publicitarios existentes y por existir así como en todos los medios que determine el Organizador a su propia discreción en contracción directa y por escrito de lo contrario no será responsable de otras publicaciones. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingSixteen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseSixteen" aria-expanded="false" aria-controls="collapseSixteen">
					...
					<div id="collapseSixteen" class="collapse" aria-labelledby="headingSixteen" data-parent="#accordion">
						<div class="card-body">
							<p>Para atender cualquier duda, consulta, queja, pregunta, reclamación o solicitud de cualquier tipo de información relacionada con sus datos personales, particularmente, para ejercer sus derechos a conocer, actualizar, rectificar y suprimir el dato o revocar la autorización otorgada, GRUPO PREVENIR ha dispuesto a admin@prevenirexpress.com, como encargado.</p>
							<p>16.1. El deber de actualización de datos por parte del titular El titular de los datos tiene la obligación de mantener actualizados los datos personales que haya suministrado a GRUPO PREVENIR. Hasta el máximo permitido por la Ley, GRUPO PREVENIR no se hace responsable por la falta de actualización de datos personales por parte del titular de los mismos. 16.2. CONSULTAS: GRUPO PREVENIR dispone de mecanismos para que el titular, sus causahabientes, sus representantes y/o apoderados, aquellos que por estipulación a favor de otro o para otro estén legitimados, los representantes de menores de edad titulares, formulen CONSULTAS respecto de cuáles son los datos personales del titular que reposan en las bases de datos de GRUPO PREVENIR. Estos mecanismos podrán ser físicos como a través del correo electrónico de pqrs@prevenirexpress.com o del contáctenos de nuestra web encargados de recepcionar las peticiones, quejas y reclamos. Cualquiera que sea el medio, GRUPO PREVENIR guardará prueba de la consulta y su respuesta. 16.3 Antes de proceder, el responsable de atender la consulta verificará: La identidad del titular del dato personal o su representante. Para ello, exigirá la cédula de ciudadanía o documento de identificación original del titular y los poderes especiales o generales según sea el caso. 16.4 La autorización o contrato con terceros que dieron origen al Tratamiento del dato personal del titular, por parte de GRUPO PREVENIR. Si el solicitante tuviere capacidad para formular la consulta, el responsable de atenderla recopilará toda la información sobre el titular que esté contenida en el registro individual de esa persona o que esté vinculada con la identificación del titular dentro de las bases de datos de GRUPO PREVENIR. 16.5 El responsable de atender la consulta dará respuesta al solicitante siempre y cuando éste último tuviere derecho a ello por ser el titular del dato personal, su causahabiente, su representante y/o apoderado, aquellos que por estipulación a favor de otro o para otro estén legitimados, o el responsable legal en el caso de menores de edad. Esta respuesta será enviada dentro de los diez (10) días hábiles contados a partir de la fecha en la que la solicitud fue recibida por GP. Esta respuesta será obligatoria aún en los casos en que se considere que el solicitante no tiene capacidad para realizar la consulta, en cuyo caso así se le informará al solicitante y se dará opción de que demuestre el interés y capacidad aportando documentación adicional. En caso de que la solicitud no pueda ser atendida a los diez (15) hábiles, se contactará al solicitante para comunicarle los motivos por los cuales el estado de su solicitud se encuentra en trámite y señalando la fecha en la que se atenderá la consulta, la cual en ningún caso podrá superar los cinco (5) días hábiles siguientes al vencimiento del primer término. Para ello se utilizará el mismo medio o uno similar a aquel mediante el cual fue presentada la consulta. La respuesta definitiva a todas las solicitudes no puede tardar más de quince (15) días hábiles desde la fecha en la que la solicitud inicial fue recibida por GP. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingSeventeen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseSeventeen" aria-expanded="false" aria-controls="collapseSeventeen">
					...
					<div id="collapseSeventeen" class="collapse" aria-labelledby="headingSeventeen" data-parent="#accordion">
						<div class="card-body">
							<p>Dispondrá de mecanismos para que el titular, sus causahabientes, sus representantes y/o apoderados, aquellos que por estipulación a favor de otro o para otro estén legitimados, o los representantes de menores de edad titulares, puedan formular RECLAMOS respecto de (i) datos personales Tratados por GP que deben ser objeto de corrección, actualización o supresión, o (ii) el presunto incumplimiento de los deberes legales de GRUPO PREVENIR. Estos mecanismos podrán ser físicos como electrónicos, tales como como correo electrónico. Cualquiera que sea el medio, GRUPO PREVENIR GP deberá guardar prueba de la consulta y su respuesta.</p>
							<p>17.1 El RECLAMO deberá ser presentado por el titular, sus causahabientes; las personas facultadas para representar a niños, niñas o adolecentes, cuando estos sean titulares; sus representantes y/o apoderado; aquellos que por estipulación a favor de otro o para otro estén legitimados, o sus representantes, 17.2 Deberá dirigirse a legal@prevenirexpress.com Deberá contener una descripción de los hechos que dan lugar al reclamo y el objetivo perseguido (actualización, corrección o supresión, o cumplimiento de deberes).Deberá indicar la dirección y datos de contacto e identificación del reclamante. Deberá acompañarse por toda la documentación que el reclamante quiera hacer valer. 17.3 Antes de proceder, el responsable de atender el reclamo verificará: La identidad del titular del dato personal o su representante. Para ello, puede exigir la cédula de ciudadanía o documento de identificación original del Titular, y los poderes especiales o generales según sea el caso. La autorización o contrato con terceros que dieron origen al Tratamiento, por parte de la GP, del dato personal del titular. Si el reclamo o la documentación adicional están incompletos, GP requerirá al reclamante por una sola vez dentro de los cinco (5) días siguientes a la recepción del reclamo para que subsane las fallas. Si el reclamante no presenta la documentación e información requerida dentro de los dos (2) meses siguientes a la fecha del reclamo inicial, se entenderá que ha desistido del reclamo. Si por cualquier hecho la persona que recibe el reclamo al interior de GP no es competente para resolverlo, dará traslado a legal@prevenirexpress.com dentro de los dos (2) días hábiles siguientes a haber recibido el reclamo, e informará de dicha remisión al reclamante. Una vez recibido el reclamo con la documentación completa, se incluirá en la base de datos de GP donde reposen los datos del titular sujetos a reclamo una leyenda que diga “reclamo en trámite” y el motivo del mismo, en un término no mayor a dos (2) días hábiles. Esta leyenda deberá mantenerse hasta que el reclamo sea decidido. 17.3 El término máximo para atender el reclamo será de quince (15) días hábiles contados a partir del día siguiente a la fecha de su recibo. Cuando no fuere posible atender el reclamo dentro de dicho término, se informará al interesado los motivos de la demora y la fecha en que se atenderá su reclamo, la cual en ningún caso podrá superar los ocho (8) días hábiles siguientes al vencimiento del primer término. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingEighteen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseEighteen" aria-expanded="false" aria-controls="collapseEighteen">
								18. VIGENCIA
					...
					<div id="collapseEighteen" class="collapse" aria-labelledby="headingEighteen" data-parent="#accordion">
						<div class="card-body">
							<p>Esta Política empezará a regir desde la fecha (septiembre 2016). Los datos personales que sean almacenados, utilizados o transmitidos permanecerán en la base de datos de GRUPO PREVENIR GP, durante el tiempo que sea necesario para las finalidades mencionadas en esta Política, para las cuales fueron recolectados. </p>
							<p>8.2 El usuario puede presentar ante la Superintendencia de Industria y Comercio quejas por infracciones a la Ley 1581 de 2012 y al Decreto 1377 de 2013.Revocar su autorización y/o solicitar la supresión de sus datos personales de las bases de datos e GRUPO PREVENIR GP, siempre y cuando no exista un deber legal (cuando el usuario ha realizado compras directas existe una obligación legal y tributaria de dejar el registro de las compras realizadas, por lo cual esta información debe permanecer en el registro de ventas de GRUPO PREVENIR GP, lo anterior con fundamento al artículo 60 C.C) o una obligación de carácter contractual en cabeza del titular con GRUPO PREVENIR GP, en virtud de la cual el titular no tenga el derecho de solicitar la supresión de sus datos personales o revocar su autorización para el Tratamiento de los mismos. Si no hay un deber legal o contractual y GRUPO PREVENIR GP no ha suprimido los datos personales del titular de sus bases de datos o no ha revocado la autorización de quien está legitimado para revocarla dentro del término legal para ello, el titular podrá acudir a la Superintendencia de Industria y Comercio para que exija la revocación de la autorización y/o la supresión de los datos personales. Solicitar acceso y acceder en forma gratuita a sus datos personales que hayan sido objeto de Tratamiento. Esta Política garantiza que cualquier información que nos provea será mantenida de manera privada y segura. Para dar fe de esto, en este documento proveemos los detalles de qué información recabamos y de qué manera la utilizamos. Nunca recolectaremos información sin su consentimiento explícito, previo e informado18.3 Quien diligencia el formulario de registro acepta y autoriza el tratamiento de sus datos personales y que los mismos se incorporen a las bases de datos de GRUPO PREVENIR GP, sus filiales o subsidiarias de acuerdo con lo estipulado en las Políticas de Tratamiento de la Información. </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingNineteen">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseNineteen" aria-expanded="false" aria-controls="collapseNineteen">
					...
					<div id="collapseNineteen" class="collapse" aria-labelledby="headingNineteen" data-parent="#accordion">
						<div class="card-body">
							<p>La participación en esta Actividad, mediante el registro en la App de GRUPO PREVENIR GP y específicamente la recepción de los PREVI-descuentos significará la plena aceptación, de parte de los Participantes, de estos Términos y Condiciones, la cual se formalizará en la declaración de aceptación.</p>
							<p>Estos Términos y Condiciones se encontrarán disponibles para consulta en el sitio web www.prevenirexpress.com </p>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header cardTitulo" id="headingTwenty">
						<h5 class="mb-0">
							<button class="btn btn-link collapsed cartText" data-toggle="collapse" data-target="#collapseTwenty" aria-expanded="false" aria-controls="collapseTwenty">
								20. LEY APLICABLE
					...
					<div id="collapseTwenty" class="collapse" aria-labelledby="headingTwenty" data-parent="#accordion">
						<div class="card-body">
							<p>Estos términos y condiciones, así como las Políticas de Privacidad y Manejo e Información de uso se regirán e interpretarán de acuerdo con las leyes de la república de Colombia. </p>
						</div>
					</div>
				</div>
			</div>
