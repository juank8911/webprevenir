  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav justify-content-center mr-auto">
      <li class="menu nav-item active">
       <a href="#" onclick="cargaContenido('views/Paginas/inicio2.php');return false;">Inicio</a>
      </li>
      ...
      <li class="menu nav-item dropdown">
       ...
       <li class="menu nav-item active">
        ...
        <li class="menu nav-item active">
        <a href="#" onclick="cargaContenido('views/Paginas/Terminos2.php');return false;">Términos y Condiciones <span class="sr-only">(current)</span></a>
      </li>
    </ul>
    </div>
     <div class="col-md-1"></div>
